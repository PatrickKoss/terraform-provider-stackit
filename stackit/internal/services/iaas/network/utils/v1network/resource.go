...
func Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse, client iaas.DefaultApi) { // nolint:gocritic // function signature required by Terraform
...
func Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse, client iaas.DefaultApi) { // nolint:gocritic // function signature required by Terraform
	var model networkModel.Model
...
func Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse, client iaas.DefaultApi) { // nolint:gocritic // function signature required by Terraform
	// Retrieve values from plan
	var model networkModel.Model
	diags := req.Plan.Get(ctx, &model)
	resp.Diagnostics.Append(diags...)
...
func Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse, client iaas.DefaultApi) { // nolint:gocritic // function signature required by Terraform
	// Retrieve values from state
	var model networkModel.Model
	diags := req.State.Get(ctx, &model)
	resp.Diagnostics.Append(diags...)
